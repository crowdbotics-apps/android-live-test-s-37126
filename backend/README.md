...
## Project Structure
    ...
    ├── android_live_test_s_37126  # Django project configurations
...
1. Clone this repo and `cd android_live_test_s_37126`
...
2. Clone this repo and `cd android_live_test_s_37126`
